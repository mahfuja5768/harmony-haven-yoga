...
const Footer = () => {
  ...
  return (
    <div className=" relative bg-primary pt-24 rounded-t-full">
      <div className="max-w-[1240px] mx-auto text-white">
        <div className="">
          <div className=" flex flex-col md:flex-row gap-5 justify-between items-center border-b-2 border-r-4 p-5 border-dotted">
            <div className="">
          ...
          <div className="flex gap-5 justify-between items-center border-t-2 border-l-4 p-5 border-dotted">
            <div>
