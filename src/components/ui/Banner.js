...
const Banner = () => {
  return (
    <div className=" bg-[#d1d5cc] py-2 rounded-b-full border-b-4 border-r-primary ">
      <Container>
        <div className="grid grid-cols-1 xl:grid-cols-2 justify-center md:justify-between gap-6 items-center">
          ...
          <div className="flex gap-6 space-y-5">
            ...
            <div className=" hidden xl:flex  flex-col justify-evenly text-primary gap-3 text-2xl">
              <a
                ...
                target="blank"
              >
                <FaDribbble className="text-primary"></FaDribbble>
              </a>
              <a
                href="https://www.dribbble.com/"
                className="hover:-translate-y-2 duration-300 bg-secondary text-black p-2 hover:bg-transparent hover:text-secondary"
              ...
              <a
                ...
                target="blank"
              >
                <IoLogoWhatsapp className="text-primary"></IoLogoWhatsapp>
              </a>
            </div>
          </div>
        </div>
